...
class SegmentationTask(pl.LightningModule):
    ...
    def __init__(
        self,
        prediction_dir:str='/app/unetr/pretrained_models',
        test_validation_dir: str='/app/unetr/pretrained_models',
        pretrained_file_path: str='/app/UNETR_model_best_acc.pth',
        in_channels: int = 1,
        out_channels: int = 14,
        roi_size: Tuple[int, int, int] = (96, 96, 96),
        new_out_channels: int = 14,
